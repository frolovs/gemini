...
var Browser = inherit({
    ...
    captureFullscreenImage: function() {
        switch (this.needsNativeContext) {
            case false:
                return this._takeScreenshot();
            case true:
                return this._takeScreenshotWithNativeContext();
            default: //undefined
                return this._pickRequiredScreenshotContext();
        }
    },

    _pickRequiredScreenshotContext: function() {
        var _this = this;
        return this._takeScreenshot()
            .then(function(screenshot) {
                _this._needNativeContext = false;
                return screenshot;
            })
            .fail(function(e) {
                return _this._takeScreenshotWithNativeContext()
                    .then(function(screenshot) {
                        _this._needNativeContext = true;
                        return screenshot;
                    });
            });
    },
